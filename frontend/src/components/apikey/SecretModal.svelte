...
{#if key != null}
    ...
    >
        <div class="flex flex-col">
            ...
            <div
                class="mt-6 text-center font-mono text-primary-600 dark:text-primary-500"
            ...
            <div class="flex flex-row justify-center">
                ...
                <Tooltip bind:open={copiedTooltipOpen}>
                    ...
                    >
                        <FileCopySolid
                            class="h-5 w-5 hover:text-primary-600 dark:hover:text-primary-500"
                        />
                    </button>
            ...
            <h3 class="mt-6 text-center text-lg font-normal text-gray-500 dark:text-gray-400">
                This secret is only shown <span class="text-primary-600 dark:text-primary-500"
                    >once</span
                >.<br />Please make sure to
